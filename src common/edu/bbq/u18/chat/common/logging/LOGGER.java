package edu.bbq.u18.chat.common.logging;
...
public final class LOGGER 
{
	...
	{
		APP_LOGGER.log(level, new StringBuilder ("[").append(System.getProperty("user.name")).append("] ").append(message).toString());
	}
	/*************************************************************************************/
	public static void log(Level level, StringBuilder message) 
	{
		APP_LOGGER.log(level, message.toString());
	}
	/*************************************************************************************/
}
